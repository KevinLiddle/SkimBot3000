...
public class Seeds {
  ...
  public static void seed() {
    ...
    Database.add(new Question("Which is your favorite musical genre?", new String[] {"Rock", "Gangta Rap", "Indie", "Dubstep", "80s", "Classical", "Other"}, 3));
    ...
    Database.add(new Question("Where do you get your coffee from?", new String[] {"Starbucks", "Caribou", "Intelligentsia", "Grocery Store", "I grow my own beans and make my own", "I import beans directly from Brazil", "I don't drink coffee"}, 5));
